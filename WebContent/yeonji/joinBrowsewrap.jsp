                    ...
                    <div id="formCon">
                        <form id="regist">
                            ...
                            <div class="agreeBox">
                                ...
                                WORLD CINEMA 이용약관 동의 <span class="font-red">(필수)</span>
                                <p>
                                    여러분을 환영합니다. WORLD CINEMA 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본
                                    약관은 다양한 WORLD CINEMA 서비스의 이용과 관련하여 WORLD CINEMA 서비스를 제공하는 WORLD
                                    CINEMA 주식회사(이하 ‘WORLD CINEMA’)와이를 이용하는 WORLD CINEMA 서비스 회원(이하
                                    ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 WORLD CINEMA 서비스 이용에 도움이 될 수
                                    있는 유익한 정보를 포함하고 있습니다. WORLD CINEMA 서비스를 이용하시거나 WORLD CINEMA 서비스
                                    회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로, 잠시 시간을 내시어 주의
                                    깊게 살펴봐 주시기 바랍니다. 다양한 WORLD CINEMA 서비스를 즐겨보세요. WORLD CINEMA는
                                    WORLD CINEMA 도메인의 웹사이트 및 응용프로그램(어플리케이션, 앱)을 통해 정보 검색, 다른 이용자와의
                                    커뮤니케이션, 콘텐츠 제공, 상품 쇼핑 등 여러분의 생활에 편리함을 더할 수 있는 다양한 서비스를 제공하고
                                    있습니다. 여러분은 PC, 휴대폰 등 인터넷 이용이 가능한 각종 단말기를 통해 각양각색의 WORLD CINEMA
                                    서비스를 자유롭게 이용하실 수 있으며, 개별 서비스들의 구체적인 내용은 각 서비스 상의 안내, 공지사항, WORLD
                                    CINEMA 웹고객센터(이하 ‘고객센터’) 도움말 등에서 쉽게 확인하실 수 있습니다. WORLD CINEMA는
                                    ...
                                    상의 안내, 공지사항, 고객센터 도움말 등에서 확인하실 수 있습니다. WORLD CINEMA 서비스에는 기본적으로
                                    본 약관이 적용됩니다만 WORLD CINEMA가 다양한 서비스를 제공하는 과정에서 부득이 본 약관 외 별도의 약관,
                                    운영정책 등을 적용하는 경우가 있습니다. 그리고 WORLD CINEMA 계열사가 제공하는 특정 서비스의 경우에도
                                    해당 운영 회사가 정한 고유의 약관, 운영정책 등이 적용될 수 있습니다. 이러한 내용은 각각의 해당 서비스 초기
                                    화면에서 확인해 주시기 바랍니다. 회원으로 가입하시면 WORLD CINEMA 서비스를 보다 편리하게 이용할 수
                                    있습니다. 여러분은 본 약관을 읽고 동의하신 후 회원 가입을 신청하실 수 있으며, WORLD CINEMA는 이에
                                    대한 승낙을 통해 회원 가입 절차를 완료하고 여러분께 WORLD CINEMA 서비스 이용 계정(이하 ‘계정’)을
                                    부여합니다. 계정이란 회원이 WORLD CINEMA 서비스에 로그인한 이후 이용하는 각종 서비스 이용 이력을 회원
                                    별로 관리하기 위해 설정한 회원 식별 단위를 말합니다. 회원은 자신의 계정을 통해 좀더 다양한 WORLD
                                    CINEMA 서비스를 보다 편리하게 이용할 수 있습니다. 이와 관련한 상세한 내용은 계정 운영정책 및 고객센터 내
                                    WORLD CINEMA 회원가입 방법 등에서 확인해 주세요.<br>...
                                </p>
                            </div>
                            ...
                            <div class="agreeBox agreeImpor">
                                ...
                                <p>
                                    개인정보보호법에 따라 WORLD CINEMA에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집
                                    및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니
                                    자세히 읽은 후 동의하여 주시기 바랍니다.<br> 1. 수집하는 개인정보<br>이용자는 회원가입을
                                    하지 않아도 정보 검색, 뉴스 보기 등 대부분의 WORLD CINEMA 서비스를 회원과 동일하게 이용할 수
                                    있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을
                                    할 경우, WORLD CINEMA는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다. 회원가입 시점에
                                    WORLD CINEMA가 이용자로부터 수집하는 개인정보는 아래와 같습니다.<br> - 회원 가입 시에
                                    ...
                                    수집합니다.<br> 2. 수집한 개인정보의 이용<br>WORLD CINEMA 및 WORLD
                            ...
                            <div class="agreeBox">
                                ...
                                <p>
                                    위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 WORLD CINEMA 위치기반
                                    서비스를 이용할 수 있습니다.<br>제 1 조 (목적)<br>이 약관은 WORLD CINEMA
                            ...
                            <div class="agreeBox">
                                ...
                                <p>WORLD CINEMA에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(WORLD CINEMA앱 알림
                                    또는 문자), 이메일로 받아보실 수 있습니다. 일부 서비스(별도 회원 체계로 운영하거나 WORLD CINEMA 가입
